...
class page:
    ...
    def init( self, lang='en', css=None, metainfo=None, title=None, header=None,
            internalCss=None, internalJs=None,
        ...
        if self.mode == 'strict_html' or self.mode == 'loose_html':
            ...
            if internalCss is not None:
                self.internalCss(internalCss)
            if internalJs is not None:
                self.internalJs(internalJs)
    ...
    def internalCss(self, css):
        if isinstance(css, basestring):
            self.style(css)

    def internalJs(self, js):
        if isinstance(js, basestring):
            self.script(js, type="text/javascript")
